...
// // --- REMOVED LazyLoadImage imports ---

// const API = import.meta.env.VITE_API_URL || 'http://localhost:5000/api';
// // Define the backend URL explicitly for reliability
...
//                   {/* --- UPDATED: Replaced LazyLoadImage with standard <img> tag --- */}
//                   {issue.imageUrl ? (
//                     <img
//                       alt={issue.title}
