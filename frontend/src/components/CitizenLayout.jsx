...
// // import { FaHome, FaChartBar, FaList, FaMap } from 'react-icons/fa';
// // import { FaHome, FaPlus, FaList, FaMapMarkedAlt } from 'react-icons/fa'; // Changed icon
// // CORRECT - FaMap is now included
// import { FaHome, FaChartBar, FaList, FaMap } from 'react-icons/fa';
...
//     { to: "/report", icon: <FaPlus size={20} />, text: "Report" }, // Changed from Reports
//     { to: "/my-issues", icon: <FaList size={20} />, text: "My Issues" },
//     { to: "/nearby", icon: <FaMapMarkedAlt size={20} />, text: "Nearby" },
//     { to: "/map", icon: <FaMap size={20} />, text: "Map" }, // Changed this line
// ];
...
//         </nav>
//       </footer>
//        {/* Spacer for mobile view to prevent content from hiding behind the bottom nav */}
